...
"""
Converts the given pdf (bytes) into png, then returns the result
as an array of bytes (each element of the array corresponds
to an image of one of the pages)
"""
@functools.cache
def pdf_bytes_to_pngs_bytes(pdf_bytes: bytes):
...
"""
@functools.cache
def pdf_bytes_to_pngs_base64(pdf_bytes: bytes):
    page_images_bytes = pdf_bytes_to_pngs_bytes(pdf_bytes)
    page_images_base64 = [
        base64
